...
public class TeamComparatorMainWithLambda implements Comparator<Team>{
	...
	public static void main(String[] args) throws Exception{
		try{
			...
			//Collections.sort(teams, new TeamComparatorMainWithLambda());
			teams.sort((Team o1, Team o2) -> (int)o1.getNumberOfMatches() - (int)o2.getNumberOfMatches());
