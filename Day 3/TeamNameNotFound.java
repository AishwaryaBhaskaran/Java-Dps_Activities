...
class TeamNameNotFound1 extends Exception{
	TeamNameNotFound1(String s){
		super(s);
	}
}
public class TeamNameNotFound {
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			{
					throw new TeamNameNotFound1("Entered team '"+teamName2+"' is not a part of IPL Season 13");
			}
			}
			else
			{
				throw new TeamNameNotFound1("Entered team '"+teamName1+"' is not a part of IPL Season 13");
			}
		  }
		catch(Exception e)
		{
